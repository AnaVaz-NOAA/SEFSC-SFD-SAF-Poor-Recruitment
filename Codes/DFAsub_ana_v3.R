...
enviro_names <- colnames(recruitment)
...
plotName <- paste("env_load_states.png") # , sep = "")
...
for (i in 1:N.ts) {
  ...
  plotName <- paste("enviro_fit_", i, ".png", sep = "")
...
## Extract recruitment and environmental covariates
environment <- recruit.dat[, c(4,8,12,16,20,36,40,5,9,13,17,21,37,41)]   # Environmental covariates only winter and summer
enviro_names <- colnames(environment)
...
plotName <- paste("envWinterSummer_load_states.png") # , sep = "")
...
for (i in 1:N.ts) {
  ...
  plotName <- paste("enviroWinterSummer_fit_", i, ".png", sep = "")
  png(filename = plotName, width = 800, height = 600) 
...
###############################################################################
# Just Summer and Winter + Chrolophil 
## Extract the years and convert to factor
years <- recruit.dat[, 1]
recruit.dat$year <- as.factor(recruit.dat[, 1])

## Extract recruitment and environmental covariates
#environment <- recruit.dat[, c(4,8,12,16,20,36,40,24,32,5,9,13,17,21,37,41,25,29,33)]  
environment <- recruit.dat[, c(4,8,12,16,20,36,40,24,5,9,13,17,21,37,41,25,29)]    
# Environmental covariates only winter and summer
enviro_names <- colnames(environment)
...
plotName <- paste("envWinterSummerChlGlb_load_states.png") # , sep = "")
...
for (i in 1:N.ts) {
  ...
  plotName <- paste("enviroWinterSummerChlGlb_fit_", i, ".png", sep = "")
  png(filename = plotName, width = 800, height = 600) 
...
plotName <- paste("rec_load_states.png") # , sep = "")
...
for (i in 1:N.ts) {
  ...
  plotName <- paste("rec_fit_", i, ".png", sep = "")
  png(filename = plotName, width = 800, height = 600) 
