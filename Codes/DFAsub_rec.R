...
recruit.dat <- read.csv("Recdevs.csv", header=TRUE)
head(recruit.dat)
dim(recruit.dat)
str(recruit.dat)

##convert year to a factor
recruit.dat$year <- as.factor(recruit.dat$year)
str(recruit.dat)

##making a separate file to use to label years on the graph
recruit.dat1 <- read.csv("Recdevs.csv", header=TRUE)
head(recruit.dat1)
dim(recruit.dat1)
str(recruit.dat1)

##convert year to a factor
recruit.dat1$year <- as.factor(recruit.dat1$year)
str(recruit.dat1)
