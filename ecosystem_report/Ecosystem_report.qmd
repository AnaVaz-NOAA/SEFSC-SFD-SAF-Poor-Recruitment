...
-   Species interactions - Lauren Gentry and David Chagaris ECOSIM/ECOPATH for RS
    ...
    -   analyses that Lauren did - species interactions could drive something like black sea bass to local extinction. Ran through model what if keep rebuilding to 2024. Too much prey switching (generalist predators). Have niche overlap, different metrics. Need to put those numbers into context.
